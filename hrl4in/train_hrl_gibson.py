...
from hrl4in.rl.ppo import PPO, Policy, MetaPolicy, RolloutStorage, AsyncRolloutStorage
...
def main():
    ...
    # ================================== load environment function start ======================================= 
    ...
    def load_env(env_mode, device_idx):
        ...
        # run_train/evl_gibson's env_type is interactive_gibson 
